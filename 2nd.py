...
if app_mode =='About App':
    ...
    st.markdown('''
              # About Us \n 
                Hey this is **FingerTalk**. Working on the technologies such as **Tensorflow, MediaPipe, OpenCV, ResNet50**. \n

                Also check me out on Social Media
                - [LinkedIn]()
                - [GitHub]()
                - If you are facing any issue while working feel free to mail me on **tmslsih@gmail.com**
    ...
    while True:
        ...
        if results.multi_hand_landmarks:
            for hand_landmark in results.multi_hand_landmarks:
                ...
                if lm_list[3].x > lm_list[4].x and lm_list[8].y > lm_list[6].y and lm_list[12].y > lm_list[10].y and \
                        lm_list[16].y > lm_list[14].y and lm_list[20].y > lm_list[18].y :
                    cv2.putText(img, "ZERO", (20, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 3)
                    my_list.append("0")
                ...
                # H
                if lm_list[2].y > lm_list[4].y and lm_list[8].x > lm_list[6].x and lm_list[12].x > lm_list[10].x and \
                        lm_list[16].x > lm_list[14].x and lm_list[20].x > lm_list[18].x: #and lm_list[17].y > lm_list[
                    #0].y > \
                       # lm_list[5].y:
